...
#define map_property_array(object, property, property_str, key, value, allocator, type,  \
                           serialize)                                                    \
    do {                                                                                 \
...
static void role_tag_strings(cord_role_tag_t *role_tag, string_ref key,
    ...
    map_property(role_tag, subscription_listing_id, "subscription_listing_id", key,
                 builder);
}
...
static void role_tag_booleans(cord_role_tag_t *role_tag, string_ref key, bool builder) {
    ...
    map_property(role_tag, available_for_purchase, "available_for_purchase", key,
                 builder);
...
static void channel_mention_numbers(cord_channel_mention_t *mention, string_ref key,
                                    i64 value) {
...
cord_serialize_result_t cord_embed_image_serialize(json_t *json_embed_image,
                                                   cord_bump_t *allocator,
...
cord_embed_thumbnail_serialize(json_t *json_embed_thumbnail, cord_bump_t *allocator,
...
cord_serialize_result_t cord_embed_video_serialize(json_t *json_embed_video,
                                                   cord_bump_t *allocator,
...
cord_serialize_result_t cord_embed_provider_serialize(json_t *json_message,
                                                      cord_bump_t *allocator,
...
cord_serialize_result_t cord_embed_field_serialize(json_t *json_embed_field,
                                                   cord_bump_t *allocator,
...
cord_serialize_result_t cord_embed_serialize(json_t *json_embed, cord_bump_t *allocator) {
    ...
    json_object_foreach(json_embed, key, value) {
        if (json_is_string(value)) {
            ...
            map_property_object_collectible(embed, thumbnail, "thumbnail", key, value,
                                            allocator, cord_embed_thumbnail_t,
            ...
            map_property_object_collectible(embed, provider, "provider", key, value,
                                            allocator, cord_embed_provider_t,
