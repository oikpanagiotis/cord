...
typedef struct cord_role_tag_t {
	...
	bool premium_subscriber; // The docs mark this as of type null. Check if it's used at all
...
typedef struct cord_message_t {
	...
	i32 flags; // combined as a bitfield(check bitwise operators on how to check the fieldset)
