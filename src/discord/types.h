...
cord_serialize_result_t cord_channel_mention_serialize(json_t *data, cord_bump_t *allocator);
...
cord_serialize_result_t cord_embed_thumbnail_serialize(json_t *data, cord_bump_t *allocator,
...
cord_serialize_result_t cord_embed_provider_serialize(json_t *data, cord_bump_t *allocator,
