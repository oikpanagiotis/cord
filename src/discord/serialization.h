...
// TODO!!! Use this to build a json payload builder with an api that is imperative
// example
/*
...
// void json_payload_apply_transformer(json_payload_t payload, transformer_t *transformer);
